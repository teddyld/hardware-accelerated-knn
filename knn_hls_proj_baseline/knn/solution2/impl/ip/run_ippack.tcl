...
set Interfaces {
    s_axi_AXILiteS {
        ...
        addr_bits "21"
        port_width "AWADDR 21 WDATA 32 WSTRB 4 ARADDR 21 RDATA 32"
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 input_V_1 W 0x0 "Data signal of input_V" {{0 32 input_V W 0 "Bit 31 to 0 Data signal of input_V"}}} {0x14 input_V_2 W 0x0 "Data signal of input_V" {{0 32 input_V W 0 "Bit 63 to 32 Data signal of input_V"}}} {0x18 input_V_3 W 0x0 "Data signal of input_V" {{0 32 input_V W 0 "Bit 95 to 64 Data signal of input_V"}}} {0x1c input_V_4 W 0x0 "Data signal of input_V" {{0 32 input_V W 0 "Bit 127 to 96 Data signal of input_V"}}} {0x20 input_V_5 W 0x0 "Data signal of input_V" {{0 32 input_V W 0 "Bit 159 to 128 Data signal of input_V"}}} {0x24 input_V_6 W 0x0 "Data signal of input_V" {{0 32 input_V W 0 "Bit 191 to 160 Data signal of input_V"}}} {0x28 input_V_7 W 0x0 "Data signal of input_V" {{0 32 input_V W 0 "Bit 223 to 192 Data signal of input_V"}}} {0x2c input_V_8 W 0x0 "Data signal of input_V" {{0 32 input_V W 0 "Bit 255 to 224 Data signal of input_V"}}} {0x30 input_V_9 W 0x0 "Data signal of input_V" {{0 32 input_V W 0 "Bit 287 to 256 Data signal of input_V"}}} {0x34 input_V_10 W 0x0 "Data signal of input_V" {{0 32 input_V W 0 "Bit 319 to 288 Data signal of input_V"}}} {0x38 input_V_11 W 0x0 "Data signal of input_V" {{0 32 input_V W 0 "Bit 351 to 320 Data signal of input_V"}}} {0x3c input_V_12 W 0x0 "Data signal of input_V" {{0 32 input_V W 0 "Bit 383 to 352 Data signal of input_V"}}} {0x40 input_V_13 W 0x0 "Data signal of input_V" {{0 20 input_V W 0 "Bit 403 to 384 Data signal of input_V"} {20 12 RESERVED R 0 "Reserved.  0s on read."}}} {0x100000 output_V R 0x0 "Data signal of output_V" {{0 1 output_V R 0 "Bit 0 to 0 Data signal of output_V"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x100004 output_V_ctrl R 0x0 "Control signal of output_V" {{0 1 output_V_ap_vld R 0 "Control signal output_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories "train_samples_V {base_address 524288 range 524288}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 2514034 II x}
