...
set_directive_array_partition -type complete -dim 1 "knn" distances
set_directive_unroll "knn/data_loop"
set_directive_unroll "knn/freq_init_loop"
set_directive_pipeline "knn/distance_loop"
set_directive_unroll "knn/label_ini_loop"
